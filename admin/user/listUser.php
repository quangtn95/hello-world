                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <thead>
                            <tr align="center" class="thead">
                                <td>#</td>
                                <td><span class="glyphicon glyphicon-user"></span>&nbsp;Userame</td>
                                <td><span class="glyphicon glyphicon-lock"></span>&nbsp;Password</td>
                                <td><span class="glyphicon glyphicon-envelope"></span>&nbsp;Email</td>
                                <td><span class="glyphicon glyphicon-question-sign"></span>&nbsp;Role</td>
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <a href="deleteUser.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
