...
<body>
    <?php
        ...
        $sql="select * from employees where dep_name ='$dep_name'";
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <thead>
                            <tr align="center" class="thead">
                                ...
                                <td><span class="glyphicon glyphicon-user"></span>&nbsp;Sex</td>
                                <td><span class="glyphicon glyphicon-calendar"></span>&nbsp;Birthday</td>
                                <td><span class="glyphicon glyphicon-folder-open"></span>&nbsp;Job Title</td>
                                <td><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Department</td>
                                <td><span class="glyphicon glyphicon-envelope"></span>&nbsp;Email</td>
                                <td><span class="glyphicon glyphicon-th"></span>&nbsp;Action</td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    ...
                                    <a href="deleteEmp.php?id=<?php echo $data['id']; ?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                    ...
                    <a href="../dep/listDep.php" class="btn btn-default">Back</a>
                </div>
                <!-- /.row -->
            </div>
            <!-- /.container-fluid -->
