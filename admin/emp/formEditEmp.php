                    ...
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<form id="registration_form" name="form2" method="POST" enctype="multipart/form-data" action="editEmp.php" accept-charset="utf-8">
									...
									<div class="row">
										...
										<div class="col-sm-7">
											<div class="form-group">
												...
												<input name="txtname" class="form-control" maxlength="100" type="text" id="form_name" value="<?php echo $data['name'] ?>"/>
											...
											<div class="form-group">
												...
												<input name="txtdate" class="form-control" maxlength="100" type="text" id="form_date" placeholder="YYYY-MM-DD" value="<?php echo $data['birthday'] ?>"/>
												<span class="error_form" id="date_error_message"></span>
											</div>

											<div class="form-group">
												<label>Address</label>
												<input name="txtaddress" class="form-control" maxlength="100" type="text" id="form_address" value="<?php echo $data['address'] ?>"/>
												<span class="error_form" id="address_error_message"></span>
											</div>

											<div class="form-group">
												<label>Job Title</label>
												<input name="txtjob" class="form-control" maxlength="100" type="text" id="form_job" value="<?php echo $data['job_title'] ?>"/>
												<span class="error_form" id="job_error_message"></span>
											</div>

											<div class="form-group">
												<label>Cellphone</label>
													<input name="txtcell" class="form-control" maxlength="20" type="tel" id="form_phone" value="<?php echo $data['cellphone'] ?>"/>
													<span class="error_form" id="phone_error_message"></span>
											</div>

											<div class="form-group">
												<label>Email</label>
												<input name="txtemail" class="form-control" maxlength="256" type="email" id="form_email" value="<?php echo $data['email'] ?>"/>
											...
											<div class="form-group">
												...
												<select name="txtdep" class="form-control" id="txtdep">
				                                    ...
				                                    <?php
				        								...
				        								$pre2 = $conn -> prepare($sql);
				        								$pre2 -> execute();
				                                        while ($data2 = $pre2->fetch(PDO::FETCH_ASSOC)){
		                                    		?>
		                                    		<option value="<?php echo $data2['dep_name'] ?>"><?php echo $data2['dep_name'] ?></option>
				                                    <?php
				                                        }
				                                    ?>
												</select>
