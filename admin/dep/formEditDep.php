                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form name="form2" method="POST" action="editDep.php">
                                    <div style="display:none;">
                                        <input type="hidden" name="_method" value="POST"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Department Name</label>
                                        <input name="txtname" class="form-control" maxlength="256" type="text" id="form_name" value="<?php echo $data['dep_name'] ?>"/>
                                        <input type="hidden" name="txtid" value="<?php echo $data['id']; ?>">
                                        <span class="error_form" id="name_error_message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Office Phone</label>
                                        <input name="txtcell" class="form-control" type="tel" id="form_phone" value="<?php echo $data['office_num'] ?>"/>
                                        <span class="error_form" id="phone_error_message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input name="txtemail" class="form-control" type="tel" id="form_email" value="<?php echo $data['email'] ?>"/>
